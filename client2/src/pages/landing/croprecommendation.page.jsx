  ...
  const cropSubmit = async (data) => {
    try {
      ...
      let response = await axios.post(
        import.meta.env.VITE_MLAPI_URL + "crop-predict",
        data,
        {
          timeout: 30000,
      ...
      let res = await seedSvc.getSeedBySlug(
        response.data.result.toLowerCase() + "-seed"
      );
      setSeed(res.result);
            ...
            {predict ? (
              <>
                <div className="d-flex flex-column justify-content-center align-items-center text-center">
                  <h3>
                    You should Grow {predict}. You can order it's seed online
                    below
                  </h3>
                  <br />
                  {seed.title !== "" ? (
                    <>
                      ...
                      <Card style={{ width: "18rem" }} className="m-2">
                        <Card.Img
                          ...
                          onError={(e) => {
                            e.target.src =
                              "https://dummyimage.com/50x30/f2f2f2/000000&text=Seed+not+found";
                          }}
                          src={
                            seed && seed.images
                        ...
                        <Card.Body>
                          ...
                          <Card.Text>{seed.summary}</Card.Text>
                          <div>
                            <Card.Text className="text-success">
                              Rs.{seed.afterDiscount}
                            </Card.Text>
                            <div className="d-flex justify-content-center gap-2">
                              <Card.Text className="text-decoration-line-through">Rs. {seed.price}</Card.Text>
                              <Card.Text>-{seed.discount}%</Card.Text>
                            </div>
                          </div>
